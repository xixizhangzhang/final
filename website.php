...
$query = "SELECT project_id, project_name, image, project_link, project_description, category_name, first_name, last_name
		FROM project NATURAL JOIN category NATURAL JOIN post NATURAL JOIN users WHERE category_id=3 ORDER BY project_id ASC";

// $query = "SELECT project_id, project_name, project_link, project_description, category_name, first_name, last_name
